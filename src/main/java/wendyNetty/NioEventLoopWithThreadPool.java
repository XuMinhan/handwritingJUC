...
public class NioEventLoopWithThreadPool {
    ...
    public NioEventLoopWithThreadPool(int port, int threadPoolSize) throws IOException {
        // 初始化选择器、服务器套接字通道和线程池
    ...
    public NioEventLoopWithThreadPool(int port) throws IOException {
        // 初始化选择器、服务器套接字通道和线程池
        selector = Selector.open();
        serverSocketChannel = ServerSocketChannel.open();
        serverSocketChannel.bind(new InetSocketAddress(port));
